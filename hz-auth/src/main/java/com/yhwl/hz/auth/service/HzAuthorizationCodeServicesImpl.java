package com.yhwl.hz.auth.service;
...
public class HzAuthorizationCodeServicesImpl extends RandomValueAuthorizationCodeServices {

	/**
	 * 授权码模式时: 验证码有效期设置, 默认有效期为5分钟, 单位秒
	 */
	@Value("${hz.authorizationCode.expirationTime:300}")
