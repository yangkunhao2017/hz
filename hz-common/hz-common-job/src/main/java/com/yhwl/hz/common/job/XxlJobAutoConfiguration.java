package com.yhwl.hz.common.job;

import com.yhwl.hz.common.job.properties.XxlExecutorProperties;
import com.yhwl.hz.common.job.properties.XxlJobProperties;
...
public class XxlJobAutoConfiguration {
	...
	public XxlJobSpringExecutor xxlJobSpringExecutor(XxlJobProperties xxlJobProperties, Environment environment,
		...
		// 如果配置为空则获取注册中心的服务列表 "http://hz-xxl:9080/xxl-job-admin"
