 ...
 */
@Slf4j
public class HzSentinelInvocationHandler implements InvocationHandler {
	...
	HzSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			HzSentinelInvocationHandler other = (HzSentinelInvocationHandler) obj;
