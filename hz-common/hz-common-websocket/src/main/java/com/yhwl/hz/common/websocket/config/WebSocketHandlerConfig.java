package com.yhwl.hz.common.websocket.config;

import com.yhwl.hz.common.websocket.custom.HzSessionKeyGenerator;
import com.yhwl.hz.common.websocket.custom.UserAttributeHandshakeInterceptor;
import com.yhwl.hz.common.websocket.handler.CustomPlanTextMessageHandler;
import com.yhwl.hz.common.websocket.handler.CustomWebSocketHandler;
import com.yhwl.hz.common.websocket.handler.PingJsonMessageHandler;
import com.yhwl.hz.common.websocket.handler.PlanTextMessageHandler;
import com.yhwl.hz.common.websocket.holder.MapSessionWebSocketHandlerDecorator;
...
public class WebSocketHandlerConfig {
	...
	public SessionKeyGenerator sessionKeyGenerator() {
		return new HzSessionKeyGenerator();
	}
