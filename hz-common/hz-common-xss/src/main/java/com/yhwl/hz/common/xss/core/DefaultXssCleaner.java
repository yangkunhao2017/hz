...
package com.yhwl.hz.common.xss.core;

import cn.hutool.core.util.CharsetUtil;
import com.yhwl.hz.common.xss.config.HzXssProperties;
import com.yhwl.hz.common.xss.utils.XssUtil;
...
public class DefaultXssCleaner implements XssCleaner {
	...
	private final HzXssProperties properties;
	...
	public String clean(String bodyHtml) {
		...
		HzXssProperties.Mode mode = properties.getMode();
		if (HzXssProperties.Mode.escape == mode) {
			// html 转义
